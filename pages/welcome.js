  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
        {/* ── HERO ── */}
        <div style={{ position: 'relative', width: '100%', height: 'min(56vw, 460px)', minHeight: 260, overflow: 'hidden' }}>
          <img
          ...
          <div style={{
            ...
            background: 'linear-gradient(180deg, rgba(13,10,14,0) 45%, var(--bg) 100%)',
          }} />
        </div>

        {/* ── CONTENT ── */}
        <div style={{ maxWidth: 640, margin: '-40px auto 0', padding: '0 24px 100px', position: 'relative', textAlign: 'center' }}>
          <h1 style={{
